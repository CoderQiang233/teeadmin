            ...
            <div className={styles.huiyi}>
                <div className={styles.main}>
                    <div className={styles.formstyle}>
                        ...
                        >
                            <Button type="primary" onClick={this.handleSubmit} loading={this.props.protocol.loading}>提交</Button>
...
ProtocolEdit = Form.create({})(ProtocolEdit);

export default connect(
    ({protocol})=>{
        return {protocol};
    }
)(withRouter(ProtocolEdit));