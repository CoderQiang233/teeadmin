...
import PictureBanner from '../../components/IndexModule/pictureBanner'
        ...
        render() {
            ...
            return (
                ...
                >
                    ...
                    {moduleKey == 'PictureBanner' &&
                        <PictureBanner action={action} module={module} form={form}></PictureBanner>
                    }
                </Modal>
            )
        }
