...
class MeetingEdit extends Component {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
               ...
               let beginTime=values.beginTime
                ...
                values.id = this.props.location.state.tableData.id;
                this.props.dispatch({
                    type: 'meeting/edit',
                    payload: values
                })
 ...
 uploadFn = (param) => {
    ...
    render() {
        ...
        const { meetingRoom,meeting,department,tableData,protocol } = this.props.location.state;
                    ...
                    <div className={styles.formstyle}>
                        ...
                        <FormItem label='会议主题' {...formItemLayout}>
                            {getFieldDecorator('meetingName', {
                                ...
                                initialValue:tableData.meetingName
                            })(
                        ...
                        <FormItem label='会议讲师' {...formItemLayout}>
                            {getFieldDecorator('lecturer', {
                                ...
                                initialValue:tableData.lecturer
                            })(
                                <Input placeholder="会议讲师" />
                            )}
                        </FormItem>
                        <FormItem label='讲师简介' labelCol={{ span: 4 }} wrapperCol={{ span: 18 }}>
                            {getFieldDecorator('introduction', {
                                rules: [{
                                    required: true,
                                    message: '请输入讲师简介!',
                                }],
                                initialValue:tableData.introduction
                            })(
                                <BraftEditor {...editorProps} initialContent={tableData.introduction} />
                            )}
                        </FormItem>
                        ...
                        <FormItem label='开始日期' {...formItemLayout}>
                            {getFieldDecorator('beginTime', {
                                ...
                                initialValue:moment(tableData.beginTime)
                            })(
                        ...
                        {/* <FormItem label='结束日期' {...formItemLayout}>
                            {getFieldDecorator('endTime', {
                                ...
                                initialValue:moment(tableData.endTime)
                            })(
                        ...
                        <FormItem label='地点' {...formItemLayout}>
                            {getFieldDecorator('meetingRoom', {
                                ...
                                initialValue:tableData.meetingRoom
                            })(
                        ...
                        <FormItem label='主办部门' {...formItemLayout}>
                            {getFieldDecorator('inchargeDept', {
                                ...
                                initialValue:tableData.inchargeDept
                            })(
                                <Select placeholder='请选择' allowClear showSearch optionFilterProp="children" style={{ width: '100%' }}>
                                    {deptOptions}
                                </Select>
                        ...
                        <FormItem label='组织者' {...formItemLayout}>
                            {getFieldDecorator('organizer', {
                                ...
                                initialValue:tableData.organizer
                            })(
                                <Input placeholder="组织者" />
                            )}
                        </FormItem>
                        <FormItem label='会议内容' labelCol={{ span: 4 }} wrapperCol={{ span: 18 }}>
                            {getFieldDecorator('content', {
                                rules: [{
                                    required: true,
                                    message: '请输入会议内容!',
                                }],
                                initialValue:tableData.content
                            })(
                                <BraftEditor {...editorProps} initialContent={tableData.content} />
                            )}
                        </FormItem>
                        <FormItem label='参会人员' {...formItemLayout}>
                            {getFieldDecorator('members', {
                                ...
                                initialValue:tableData.members.split(',')
                            })(
                        ...
                        <FormItem label='培训协议' {...formItemLayout}>
                            {getFieldDecorator('protocol', {
                                ...
                                initialValue:tableData.protocol
                            })(
                                <Select placeholder='请选择' allowClear showSearch optionFilterProp="children" style={{ width: '100%' }}>
                        ...
                        <FormItem label='随堂考试' {...formItemLayout}>
                            {getFieldDecorator('test', {
                                ...
                                initialValue:tableData.test
                            })(
                                // <Select placeholder='请选择' allowClear showSearch optionFilterProp="children" style={{ width: '100%' }}>
                                //     <Option key='0'>无随堂考试</Option>
                                // </Select>
                                <RadioGroup >
                        ...
                        <FormItem label='签到拍照' {...formItemLayout}>
                            {getFieldDecorator('hasPhoto', {
                                ...
                                initialValue:tableData.hasPhoto
                            })(
                                <RadioGroup >
                                    <Radio value={'1'}>有</Radio>
                                    <Radio value={'0'}>无</Radio>
...
MeetingEdit = Form.create({})(MeetingEdit);

export default connect(
    ({meeting,routerReducer})=>{
        return {meeting,routerReducer};
    }
)(withRouter(MeetingEdit));